...
set files=%floc%main.c %floc%text.c %floc%memory.c %floc%util.c %floc%font_rendering.c %floc%editor.c %floc%text_manager.c %floc%text_events.c %floc%os_dependent.c %floc%interface.c %floc%interface_events.c %floc%input.c
